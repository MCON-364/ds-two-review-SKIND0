...
public class WordFrequencyCounter {
    ...
    public TreeMap<String, Long> buildFrequencyMap() {
        ...
        // TODO
        return words.stream().collect(Collectors.groupingBy(w -> w, TreeMap::new, Collectors.counting()));
    }
    ...
    public List<String> getTopN(int n) {
        // TODO
        return buildFrequencyMap().entrySet().stream().sorted(Map.Entry.<String, Long>comparingByValue().reversed())
    ...
    public List<String> getWordsStartingWith(char prefix) {
        // TODO
        return buildFrequencyMap().subMap(String.valueOf(prefix), String.valueOf((char)(prefix + 1)))
    ...
    public Optional<String> getMostFrequentInRange(String from, String to) {
        // TODO
        return buildFrequencyMap().subMap(from, true, to, true).entrySet().stream()
